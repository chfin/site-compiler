...
(defun run-test ()
  (let ((*data-dir* (rel-path "data/default.yaml"))
    ...
    (let ((*template-dir* (rel-path "templates_clemb/default.tmpl"))
          (*site-dir* (rel-path "site_clemb/default.html"))
          (*schema-dir* (rel-path "schema_clemb/default.yaml")))
      (write-line "Test cl-emb engine!")
